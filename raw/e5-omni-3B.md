...
**e5-omni-3B** is a high-performance omni-modal embedding model built on top of [Qwen2.5-Omni-3B](https://huggingface.co/Qwen/Qwen2.5-Omni-3B).  
...
<img width="900" alt="abs" src="https://huggingface.co/Haon-Chen/e5-omni-3B/resolve/main/assets/e5-omni-mmeb.png">
<img width="400" alt="abs" src="https://huggingface.co/Haon-Chen/e5-omni-3B/resolve/main/assets/e5-omni-audiocaps.png">
...
example_videos = [
    "https://huggingface.co/Haon-Chen/e5-omni-3B/resolve/main/assets/mapo_tofu.mp4",
    "https://huggingface.co/Haon-Chen/e5-omni-3B/resolve/main/assets/zhajiang_noodle.mp4",
]
...
# Video similarities: tensor([[0.5881, 0.5454]])
```
...
example_audios = [
    "https://huggingface.co/Haon-Chen/e5-omni-3B/resolve/main/assets/joe_hisaishi_summer.mp3",
    "https://huggingface.co/Haon-Chen/e5-omni-3B/resolve/main/assets/jay_chou_superman_cant_fly.mp3",
]

query_embedding = model.encode_query(example_query)
document_embeddings = model.encode_document(example_audios, batch_size=1)
print(model.similarity(query_embedding, document_embeddings))
# Audio similarities: tensor([[0.6981, 0.6028]])
```
...
example_images = [
    "https://huggingface.co/Haon-Chen/e5-omni-3B/resolve/main/assets/qwen2.5omni_hgf.png",
    "https://huggingface.co/Haon-Chen/e5-omni-3B/resolve/main/assets/llama4_hgf.png",
]

query_embedding = model.encode_query(example_query)
document_embeddings = model.encode_document(example_images, batch_size=1)
print(model.similarity(query_embedding, document_embeddings))
# Image similarities: tensor([[0.4896, 0.4097]])
```
...
print(model.similarity(query_embedding, document_embeddings))
# Text similarities: tensor([[0.7248, 0.6511]])
```
...
documents = [
    {
        ...
        "video": "https://huggingface.co/Haon-Chen/e5-omni-3B/resolve/main/assets/mapo_tofu.mp4",
    },
    {
        "image": "https://huggingface.co/Haon-Chen/e5-omni-3B/resolve/main/assets/qwen2.5omni_hgf.png",
        "audio": "https://huggingface.co/Haon-Chen/e5-omni-3B/resolve/main/assets/joe_hisaishi_summer.mp3",
    },
]
...
example_video_1 = "https://huggingface.co/Haon-Chen/e5-omni-3B/resolve/main/assets/mapo_tofu.mp4"
example_video_2 = "https://huggingface.co/Haon-Chen/e5-omni-3B/resolve/main/assets/zhajiang_noodle.mp4"
...
# Video similarities: 0.58984375 0.54296875
```

#### 🎵 Audio Retrieval
```python
example_query = "Query: A light piano piece"
example_audio_1 = "https://huggingface.co/Haon-Chen/e5-omni-3B/resolve/main/assets/joe_hisaishi_summer.mp3"
example_audio_2 = "https://huggingface.co/Haon-Chen/e5-omni-3B/resolve/main/assets/jay_chou_superman_cant_fly.mp3"
query = [{"role": "user", "content": [{"type": "text", "text": example_query}]}]
...
print("Similarities:", sim1.item(), sim2.item())
# Audio similarities: 0.703125 0.6171875
```

#### 📈 Image Document Retrieval (Image, Chart, PDF)
```python
example_query = "Query: How many input modality does Qwen2.5-Omni support?"
example_image_1 = "https://huggingface.co/Haon-Chen/e5-omni-3B/resolve/main/assets/qwen2.5omni_hgf.png"
example_image_2 = "https://huggingface.co/Haon-Chen/e5-omni-3B/resolve/main/assets/llama4_hgf.png"
query = [{"role": "user", "content": [{"type": "text", "text": example_query}]}]
...
print("Similarities:", sim1.item(), sim2.item())
# Image similarities: 0.490234375 0.408203125
```
...
print("Similarities:", sim1.item(), sim2.item())
# Text similarities: 0.7265625 0.65234375
```
