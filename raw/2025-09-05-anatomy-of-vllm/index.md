...
domain: "vllm.ai"
language: "en"
description: "How vLLM's inference engine works, covering PagedAttention, continuous batching, prefix caching, speculative decoding, multi-GPU serving, scheduling, and benchm"
word_count: 7677
---
...
> **Note:** In the [benchmarking section](#benchmarks-and-auto-tuning---latency-vs-throughput) we'll analyze the so-called roofline model of GPU perf. That will go into more detail behind prefill/decode perf profiles.
...
4. `Build metadata object` — At the end of scheduling, the scheduler calls `meta = connector.build_connector_meta`:
