...
site: "SGLang X Ascend Team"
published: July 28, 2026
source: "https://www.lmsys.org/blog/2026-07-31-cleaner-quantization-stack"
domain: "lmsys.org"
language: "en"
description: "Quantization has moved from an advanced feature to an essential part of high-throughput LLM serving. As the number of checkpoint formats, model architectures, and hardware backends grows, the quantiza..."
word_count: 1167
---
...
![Before and after quantization architecture](assets/02-diff-diagram.png)  
*Figure 1: The refactor separates format-specific weight handling from platform-specific processing and kernel execution.*
...
*Table 1: Quantization performance and accuracy comparison*  
...
| Qwen3-30B-A3B | W4A4\_W8A8 | 52.97 | 2299.51 | 23.84 | 89.4 | 21.59 |

*Refer to the appendix to reproduce the results.*
...
![Scheme-based quantization architecture](assets/03-main_scheme.png)  
*Figure 2: The scheme-based architecture separates checkpoint semantics from hardware execution.*
...
![Multiple quantization schemes reusing shared hardware kernels](assets/04-kernel_reusing_Diagram.png)  
*Figure 3: Multiple checkpoint formats can share the same backend kernel.*
