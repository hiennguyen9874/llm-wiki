...
author: "The SGLang, Miles Team"
site: "lmsys.org"
published: April 25, 2026
source: "https://www.lmsys.org/blog/2026-04-25-deepseek-v4"
domain: "lmsys.org"
language: "en"
description: "We are thrilled to announce Day-0 support for DeepSeek-V4 across both inference and RL training. SGLang and Miles form the first open-source stack to serve and train DeepSeek-V4 on launch day — with s..."
word_count: 3391
---
...
![DeepSeek-V4 decode throughput on Day-0 launch: SGLang vs other OSS engine](assets/benchmark_vs_oss.png)
...
![Figure 1](assets/fig1_attention_scope.png)
...
![Figure 2](assets/fig2_shadowradix_layout.png) *Figure 2. ShadowRadix storage layout.*
...
![DeepSeek-V4 decode throughput across context lengths](assets/benchmark.png)
...
![HiSparse architecture](assets/fig3_hisparse_arch.png) ![HiSparse peak throughput](assets/fig_hisparse_peak_throughput.png)
...
![Figure 6](assets/fig6_multi_stream_overlap.png) *Figure 6. Two-level stream fan-out for attention preparation, with fine-grained `q_lora_ready` / `q_scale_ready` events linking dependent work across streams.*
...
![Figure 4](assets/fig4_day0_rl.png) *Figure 4. Day-0 Verified RL pipeline for DeepSeek-V4: Miles and SGLang together provide stability (R3 and indexer replay, Step-0 train-inference diff ~0.02-0.03), efficiency (DP/TP/SP/EP/PP/CP, Tilelang kernels, FP8/BF16 rollout and training), and broad hardware support (Hopper, Blackwell, Grace Blackwell).*
...
![Rollout raw reward over training steps](assets/fig_miles_reward_curve.png) ![AIME eval accuracy over training steps (4096 max_len truncated)](assets/fig_miles_eval_curve.png)
