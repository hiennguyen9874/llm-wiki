...
source: "https://www.lmsys.org/blog/2026-04-10-sglang-hisparse"
domain: "lmsys.org"
language: "en"
description: "Self-attention has become a major bottleneck in scaling LLMs to long contexts because of its quadratic compute and memory/IO cost. This has driven growing interest in efficient attention mechanisms. A..."
word_count: 826
---
...
![](assets/miss_count_trend.png)

Cache miss count benchmark results for [DeepSeek-V3.2](https://huggingface.co/deepseek-ai/DeepSeek-V3.2) (top-k=2048) on LongBenchV2, with miss counts smoothed using a 100-step rolling window.
