...
domain: "vllm.ai"
language: "en"
description: "How single-node prefill/decode disaggregation in vLLM uses AMD MORI-IO on an 8-GPU MI300X node to separate prefill and decode, transfer KV cache efficiently, st"
word_count: 3905
---
...
![](assets/read-mode-request-flow-diagram.svg)
...
![](assets/write-mode-request-flow-diagram.svg)
...
**Goodput** = maximum request rate (req/s) such that requests satisfy both TTFT < *T\_ttft* and ITL < *T\_itl*.
...
![](assets/read-mode-kv-transfer-sequence-diagram.svg)
...
![](assets/write-mode-kv-transfer-sequence-diagram.svg)
...
[^1]: AMD and Embedded LLM, "The vLLM MoE Playbook: A Practical Guide to TP, DP, PP and Expert Parallelism" [https://rocm.blogs.amd.com/software-tools-optimization/vllm-moe-guide/README.html](https://rocm.blogs.amd.com/software-tools-optimization/vllm-moe-guide/README.html)

[^2]: vLLM Disaggregated Prefill Documentation [https://docs.vllm.ai/en/latest/features/disagg\_prefill/](https://docs.vllm.ai/en/latest/features/disagg_prefill/)

[^3]: DistServe: Maximizing Goodput in LLM Serving [https://haoailab.com/blogs/distserve/](https://haoailab.com/blogs/distserve/)

[^4]: MORI-IO Connector PR #29304 [https://github.com/vllm-project/vllm/pull/29304](https://github.com/vllm-project/vllm/pull/29304)

[^5]: MORI (Modular RDMA Interface) [https://github.com/ROCm/mori](https://github.com/ROCm/mori)
