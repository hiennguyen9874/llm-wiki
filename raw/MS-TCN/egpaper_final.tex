...
\def\cvprPaperID{1726} % *** Enter the CVPR Paper ID here
...
$\mathcal{L}_{cls} + \lambda \mathcal{L}_{T-MSE}$   &\textbf{76.3}&\textbf{74.0}&\textbf{64.5}&\textbf{67.9}&\textbf{80.7} \\ 
\hline
\end{tabular}%
}
...
\begin{center}
\begin{tabular}{cc}
   \includegraphics[trim={4cm .6cm 27cm .3cm},clip,width=.44\linewidth]{losses_plot_new_1} & %{3.6cm 0cm 23cm 0cm}
   \includegraphics[trim={27cm .6cm 4cm .3cm},clip,width=.44\linewidth]{losses_plot_new_1}
\end{tabular}
\end{center}
...
\begin{tabular}{lccccc}
\hline
\textbf{Impact of $\lambda$}  & \multicolumn{3}{c}{F1@\{10,25,50\}} & Edit & Acc  
\\ \hline
MS-TCN ($\lambda=0.05,\ \tau=4$)   &        74.1 &        71.7 &        62.4 &        66.6 &        80.0  \\ 
MS-TCN ($\lambda=0.15,\ \tau=4$)   &\textbf{76.3}&\textbf{74.0}&\textbf{64.5}&        67.9 &\textbf{80.7} \\ 
MS-TCN ($\lambda=0.25,\ \tau=4$)   &        74.7 &        72.4 &        63.7 &\textbf{68.1}&        78.9  \\ 
\hline
\hline
\textbf{Impact of $\tau$}  & \multicolumn{3}{c}{F1@\{10,25,50\}} & Edit & Acc  
\\ \hline
MS-TCN ($\lambda=0.15,\ \tau=3$)   &        74.2 &        72.1 &        62.2 &        67.1 &        79.4  \\ 
MS-TCN ($\lambda=0.15,\ \tau=4$)   &\textbf{76.3}&\textbf{74.0}&\textbf{64.5}&\textbf{67.9}&\textbf{80.7} \\ 
MS-TCN ($\lambda=0.15,\ \tau=5$)   &        66.6 &        63.7 &        54.7 &        60.0 &        74.0  \\ 
\hline
\end{tabular}%
}
\caption{Impact of $\lambda$ and $\tau$ on the 50Salads dataset.}
...
%&  & \multicolumn{3}{c}{F1@\{10,25,50\}} & Edit & Acc  
%\\ \hline
%w/o FT   & SS-TCN            &         53.6  &         48.6  &         35.2  &         44.6  &   67.9        \\
%         & MS-TCN (4 stages) & \textbf{83.7} & \textbf{79.4} & \textbf{65.2} & \textbf{75.4} & \textbf{74.9}        \\ 
%\hline
%with FT  & SS-TCN            &         59.6  &         54.2  &         41.2  &         47.9  &   69.6        \\
%         & MS-TCN (4 stages) & \textbf{84.4} & \textbf{81.5} & \textbf{63.7} & \textbf{77.2} & \textbf{76.3}        \\
%\hline
%
%\end{tabular}%
%}
%\caption{Effect of fine-tuning on split 1 of GTEA dataset.}
%\label{tab:fine_tuning}
%\end{table}
