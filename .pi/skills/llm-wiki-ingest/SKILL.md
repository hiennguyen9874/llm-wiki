...
- `ask-user` or review queue → handle human judgment, especially high-stakes taxonomy or irreversible structural decisions

## Ingest-Specific Principles
Core owns shared privacy, metadata, citation, naming, lifecycle, index/log, and governance rules. Ingest adds these workflow-specific rules:
...
9. Update `wiki/overview.md`, `wiki/index.md`, and `wiki/log.md` when required by core rules.
