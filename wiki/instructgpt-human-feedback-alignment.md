...
- **Related method:** [Group Relative Policy Optimization](group-relative-policy-optimization.md) retains PPO-style on-policy updates and reference KL control but replaces PPO’s learned critic with advantages normalized across multiple completions of a prompt.[^grpo-summary]
...
[^grpo-summary]: “GRPO overview” (Vietnamese summary), [raw source](../raw/GRPO.md), Sections 1–6 and 11. This is secondary-source evidence linking to DeepSeek-AI, “DeepSeekMath: Pushing the Limits of Mathematical Reasoning in Open Language Models” (2024); the primary paper has not been independently ingested here.
