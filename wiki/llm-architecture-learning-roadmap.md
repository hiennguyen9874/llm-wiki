...
| 5. Scaling and inference     | Parameter/data/compute allocation; distinction between training, prefill, and decode; [KV caching](kv-caching.md)                    | Add KV caching and compare cached versus uncached output equivalence and latency                                         | [Chinchilla allocation](chinchilla-compute-optimal-training-allocation.md), [KV-cache trade-offs](kv-cache-compression-and-trade-offs.md)                                                     |
