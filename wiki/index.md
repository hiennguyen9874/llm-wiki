...
- [Llama-Embed-Nemotron-8B](llama-embed-nemotron-8b.md) — A 7.50B-parameter Llama-3.1-8B-derived multilingual text embedding model with bidirectional attention, 4,096-dimensional outputs, and self-reported top MMTEB multilingual-v2 Borda rank in October 2025.
