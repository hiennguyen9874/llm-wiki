...
- [Qwen3-Reranker-8B](qwen3-reranker-8b.md) — An 8B-parameter, 36-layer Qwen3 point-wise reranker with a 32K-token context limit and reported June 2025 retrieval results.
...
- [Qwen3-VL-Reranker-2B](qwen3-vl-reranker-2b.md) — A 2B-parameter, 28-layer instruction-aware multimodal cross-encoder reranker with a 32K context limit and binary yes/no relevance scoring.
- [Qwen3-VL-Reranker-8B](qwen3-vl-reranker-8b.md) — An 8B-parameter, 36-layer instruction-aware multimodal cross-encoder reranker with a 32K context limit and binary yes/no relevance scoring.
