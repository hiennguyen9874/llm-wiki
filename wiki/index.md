...
- [Qwen3-VL, harrier, Qwen3, and F2LLM 4B embedding comparison](embedding-model-comparison-qwen3-vl-harrier-qwen3-f2llm.md) — A scope-aware comparison of Qwen3-VL-Embedding-2B, harrier-oss-v1-0.6b, Qwen3-Embedding-4B, and F2LLM-v2-4B for multimodal versus multilingual text embedding.
