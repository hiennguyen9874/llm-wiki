...
The source also reports a 39.5% Charades test mAP for its non-local I3D, versus 37.2% for its I3D baseline.[^nonlocal-paper] These are historical, paper-specific benchmark comparisons—not current performance, deployment-cost, or long-video evidence.
