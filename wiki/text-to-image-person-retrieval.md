...
The vault currently has four directly relevant sources:
...
#### Claim
- Statement: Among the benchmark-leading sources in the vault, reported best results progress from IRRA to RDE to MRA; TBPS-CLIP is a separate lightweight baseline study that strengthens the case for recipe design rather than defining the benchmark frontier.
- Status: active
- Confidence: 0.80
- Evidence: [[source-arxiv-2303-12501-irra]], [[source-arxiv-2308-09911-rde]], [[source-arxiv-2308-10045-tbps-clip]], [[source-arxiv-2507-10195-mra]]
- Last confirmed: 2026-04-23
- Notes: Historical benchmark-progression claim only; future sources may supersede all of these.
