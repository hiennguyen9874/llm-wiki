...
## Unreleased successor preview: YOLO27

**Synthesis:** the decision matrix above selects among deployable models. Ultralytics additionally previews YOLO27 as the successor to YOLO26 with a two-design detection split — CNN for N/S and a query-based NMS-free decoder for M/L — but with no released weights, configurations, or code and no launch date, so it cannot enter the N/S/M tables until it ships[^ultralytics-yolo27-doc-52318137-2][^ultralytics-yolo27-doc-52318137-4].

**Reported** preliminary 640 px COCO detection, RTX PRO 6000 TensorRT 11 FP16 with CPU ONNX FP32 on an AMD EPYC 9655[^ultralytics-yolo27-doc-52318137-3]:

| Model | Reported mAP | Params / FLOPs | Reported latency |
| --- | ---: | --- | --- |
| YOLO27n | 42.3 | 3.0M / 7.2B | 0.62 ms RTX PRO 6000, 16.1 ms CPU ONNX |
| YOLO27s | 49.6 | 11.8M / 28.2B | 0.79 ms, 33.2 ms |
| YOLO27m | 55.8 | 22.8M / 65.0B | 1.39 ms, 67.2 ms |
| YOLO27l | 60.4; 61.2 at 800 px | 72.3M / 165.3B | 2.32 ms; 2.9 ms at 800 px, 149.6 ms |

- **Reported:** Ultralytics frames YOLO27n/s as improving on YOLO26n/s accuracy at essentially the same speed, YOLO27m as the GPU accuracy–speed sweet spot, and YOLO27l as its first model above 60 mAP on COCO[^ultralytics-yolo27-doc-52318137-2][^ultralytics-yolo27-doc-52318137-3].
- **Synthesis:** as a same-vendor comparison the reported deltas are directionally useful — YOLO27m 55.8 and YOLO27l 60.4 sit above YOLO26-M 53.1 and YOLO26-L 55.0, and the M/L gains exceed the n/s gains (+1.4 and +1.0), consistent with the M/L query-decoder redesign rather than the N/S head simplification — but the latency hosts differ, so those are accuracy-only deltas and not deployable selections[^yolo26-2509-25164-v5-1][^ultralytics-yolo27-doc-52318137-3].
...
- **Observed** by static inspection: `raw/yolo27.md` (SHA-256 `52318137…`, 305 lines) was fully read for the two-design split, dual-scale N/S head, foreground alignment supervision, preliminary detection table, and unreleased status. No model, weight, or example was downloaded or executed, and the YOLO27 waitlist and linked task/benchmark guides were not fetched, so YOLO27 values are unreleased vendor-preliminary reports with a benchmark host that differs from every other row here.
...
[^yolo26-2509-25164-v5-1]: `raw/arXiv-2509.25164v5/template.tex`, Tab. `tab:yolo26_metrics` detection panel — 640px N 40.9/40.1 e2e at 38.9ms CPU ONNX and 1.7ms T4 TRT10 FP16 with 2.4M/5.4B; S 48.6/47.8 at 87.2ms/2.5ms with 9.5M/20.7B; M 53.1/52.5 at 220.0ms/4.7ms with 20.4M/68.2B; L 55.0/54.4 at 286.2ms/6.2ms with 24.8M/86.4B. Secs. Architectural Enhancements and Real-Time Deployment report DFL removal, native NMS-free inference, and ONNX/TensorRT/CoreML/TFLite/OpenVINO export rationale.
...
[^ultralytics-yolo27-doc-52318137-2]: `raw/yolo27.md`, sections “Overview,” “Key Features” / Query-based detection without NMS, and “Which YOLO27 Should I Use?” — N/S CNN versus M/L query-decoder split, `nms=False` NMS-free option for N/S, YOLO27m convolutional backbone, YOLO27l UltraViT backbone, and the n/m/l deployment guidance.
[^ultralytics-yolo27-doc-52318137-3]: `raw/yolo27.md`, sections “Overview” and “Performance Metrics” / Detection (COCO) plus the params/FLOPs note — preliminary 640 px n 42.3/0.62 ms/16.1 ms/3.0M/7.2B, s 49.6/0.79 ms/33.2 ms/11.8M/28.2B, m 55.8/1.39 ms/67.2 ms/22.8M/65.0B, l 60.4/2.32 ms/149.6 ms/72.3M/165.3B and 61.2 mAP at 800 px/2.9 ms; RTX PRO 6000 TensorRT 11 FP16 plus AMD EPYC 9655 ONNX FP32 protocol.
[^ultralytics-yolo27-doc-52318137-4]: `raw/yolo27.md`, intro info callout and FAQ “When will YOLO27 be available?” — unreleased weights, configurations, and implementation code with no launch date, and benchmarks that may change before release.
