...
- **Extended by:** [Jina Embeddings v5 Omni Nano](jina-embeddings-v5-omni-nano.md) through [GELATO](gelato.md), without changing this model's text-encoder weights. [^jina-v5-omni-report]
